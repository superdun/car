...
@login_required
def carIndex():
    return render_template('car/index.html', imgDomain="http://%s" % getQiniuDomain())
...
def carDetail(id):
    ...
    return render_template('car/carDetail.html', data=data, imgDomain="http://%s" % getQiniuDomain(),GPSData=GPSData)
...
def carList():
    data = Car.query.all()
    return render_template('car/carList.html', data=data, imgDomain="http://%s" % getQiniuDomain())
...
def historyDetail(id):
    ...
    return render_template('car/historyDetail.html', data=data, imgDomain="http://%s" % getQiniuDomain())
...
def historyList():
    ...
    return render_template('car/historyList.html', data=data, imgDomain="http://%s" % getQiniuDomain())
...
def mendHistoryDetail(id):
    ...
    return render_template('car/mendHistoryDetail.html', data=data, imgDomain="http://%s" % getQiniuDomain())
...
def mendHistoryList():
    ...
    return render_template('car/mendHistoryList.html', data=data, imgDomain="http://%s" % getQiniuDomain())
...
def customerDetail(id):
    ...
    return render_template('car/customerDetail.html', data=data, imgDomain="http://%s" % getQiniuDomain())
...
def customerList():
    ...
    return render_template('car/customerList.html', data=data, imgDomain="http://%s" % getQiniuDomain())
...
def carRec(id):
    ...
    return render_template('car/carRec.html', data=data, imgDomain="http://%s" % getQiniuDomain())
