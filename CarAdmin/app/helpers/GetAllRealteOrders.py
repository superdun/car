...
def GetContinueOrders(id):
    return Order.query.filter(Order.sourceid == id).all()
...
def getOrderSumData(sourceOrder, cOrders):
    ...
    if sourceOrder.fromdate:
        ...
        if endDate > actDate:
            ...
            isOver = "+"
    return {"priceSum": priceSum, "countSum": countSum, "endDate": endDateStr, "overDate": overDate, "isOver": isOver,"rawEndDate":endDate}
